...
public class AbstractReportGeneratorTest {
    ...
    private SettledAmntIncomingReportGenerator sir = new SettledAmntIncomingReportGenerator();
    private SettledAmntOutGoingReportGenerator sor = new SettledAmntOutGoingReportGenerator();
    ...
    public void generateTradeAmntReportMapOutgoing() {
        ...
        expSorMap.put("02 Jan 2016", 20.0);
